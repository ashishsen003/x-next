          ...
          >
            <div className='p-4'>
              ...
              <div className='p-2 flex items-center space-x-1 relative'>
                <span className='w-0.5 h-full z-[-1] absolsute left-8 top-11 bg-gray-300 border border-red-900'  />
              ...
              <div className='flex p-3 space-x-3'>
                ...
                <div className='w-full border-b'>
                  <textarea className='w-full border-none outline-none tracking-wide min-h-[50px] text-gray-700 placeholder:text-gray-500' placeholder='Whats happening' row='2' value={input} onChange={(e)=>setInput(e.target.value)}>
                  </textarea>
                  </div>
